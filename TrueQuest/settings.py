"""
Django settings for TrueQuest project.
...
WSGI_APPLICATION = 'TrueQuest.wsgi.application'
...
MEDIA_URL = "media/"
MEDIA_ROOT = os.path.join(os.path.dirname(BASE_DIR), "TrueQuest/TrueQuest/media")
...
EMAIL_HOST_PASSWORD = 'SIR1u_Y8y1!14W_zdf!'
EMAIL_USE_TLS = True
